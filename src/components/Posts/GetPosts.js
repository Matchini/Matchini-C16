              ...
              <div className="bg-blue p-1 font-sans">
                <div className="rounded bg-blue-light flex-col w-full border-2 bg-green-300 p-2">
                  ...
                  <div className="text-sm mt-2 flex flex-row bg-white w-full p-2 rounded mt-1 border-b border-grey  hover:bg-grey-lighter">
                    ...
                    <div className="flex">
                    {"|* "} 
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mt-1 mr-1 pl-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div className="flex">
                    {"|* "} 
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 pl-1 mt-1 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
